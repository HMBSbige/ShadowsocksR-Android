...
object Constants
{
	...
	object Action
	{
		...
		const val QUICK_SWITCH = "com.github.shadowsocks.QUICK_SWITCH"
		const val SCAN = "com.github.shadowsocks.intent.action.SCAN"
		const val SORT = "com.github.shadowsocks.intent.action.SORT"
	}
